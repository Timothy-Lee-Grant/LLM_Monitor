# Retired from app/graph/nodes.py during plan 001 Step 5 (2026_07_11). Policy checking is a non-goal for this cleanup (Stage 1 §4);
# the policy prompt itself stays live in PromptFactory. These nodes return when the policy feature is scheduled.
